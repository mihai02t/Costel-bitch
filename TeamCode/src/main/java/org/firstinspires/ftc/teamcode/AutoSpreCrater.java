...
@Autonomous
public class AutoSpreCrater extends LinearOpMode {
...
//        CameraDevice.getInstance().setFlashTorchMode(true);
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            this.sleep(100);
            this.strafeToTarget(1650, 0.5, motors);
            this.sleep(100);
...
//                    telemetry.addData("Range: ", endcolt.getState());
//                    telemetry.update();
                idle();
            }
            move(0.0, 0.0, 0.0);

//            telemetry.addData("Range: ", "Terminated");
//            telemetry.update();
...
//                idle();
//            }
            moveStraightToTarget(4600, 0.8, motors);
            move(0.0, 0.0, 0.0);
            this.sleep(100);
...
//                this.sleep(100);
            ...
            moveStraightToTargetWithBratAndCulisanta(-7000, 1.0, motors);
            servo.setPosition(0.3);
