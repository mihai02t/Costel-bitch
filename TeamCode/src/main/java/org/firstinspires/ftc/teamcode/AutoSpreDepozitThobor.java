...
@Autonomous
public class AutoSpreDepozitThobor extends LinearOpMode {
...
//        CameraDevice.getInstance().setFlashTorchMode(true);
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            this.sleep(100);
            this.strafeToTarget(1700, 0.5, motors);
            this.sleep(100);
...
//                this.sleep(300);
            ...
            if(position == GoldMineralPosition.CENTER) {
                strafeToTarget(1600, 0.7, motors);
                strafeToTarget(-1100, 0.7, motors);
            }
            else if(position == GoldMineralPosition.LEFT) {
                strafeToTarget(2300, 0.7, motors);
//                strafeToTarget(-1100, 0.6, motors);
            }
            else if(position == GoldMineralPosition.RIGHT) {
                strafeToTarget(3200, 0.8, motors);
                strafeToTarget(-2400, 0.8, motors);
            }
            this.sleep(100);
...
//            }
            if(position != GoldMineralPosition.LEFT) {
                ...
                moveStraightToTarget(-2400, 0.8, motors);
            }
            move(0.0, 0.0, 0.0);
//            this.sleep(100);
